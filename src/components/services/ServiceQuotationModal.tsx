    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-55 flex items-center justify-center p-4 bg-black/85 backdrop-blur-xs">
        <motion.div
          ...
          className="glass-card w-full max-w-lg overflow-hidden relative border-white/10 bg-zinc-950/95 shadow-[0_0_60px_rgba(217,70,239,0.1)] rounded-[28px] max-h-[90vh] flex flex-col"
        >
          {/* Modal Header */}
          ...
          <form onSubmit={handleConfirmQuote} className="p-6 overflow-y-auto space-y-5 flex-grow scrollbar-thin">
            {error && (
