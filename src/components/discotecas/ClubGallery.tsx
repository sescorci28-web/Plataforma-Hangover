  ...
  if (items.length === 0 && !showDemo) {
    return (
      <div className="space-y-4">
        ...
        <div className="text-center py-12 border border-dashed border-white/10 bg-zinc-950/20 rounded-[28px] space-y-4 shadow-lg">
          <div className="max-w-xs mx-auto space-y-1">
            <p className="text-xs text-zinc-400 font-bold uppercase tracking-wider">Galería Vacía</p>
            <p className="text-[11px] text-zinc-500 leading-relaxed">Esta discoteca aún no ha subido fotos o videos a su galería.</p>
          </div>
